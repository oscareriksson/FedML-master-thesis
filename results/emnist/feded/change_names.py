...
dir = '/home/oscar/CAS/Exjobb/FedML-master-thesis/results/emnist/feded/temp'

for res_dir in os.listdir(dir):
    info = res_dir.split('_')
    student = f"emnist_{info[5]}"
    loss = info[6]
    scheme = info[7]

    new_dir = f"/home/oscar/CAS/Exjobb/FedML-master-thesis/results/emnist/feded/{'_'.join(info[:5])}"
