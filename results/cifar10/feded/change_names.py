...
dir = '/home/oscar/CAS/Exjobb/FedML-master-thesis/results/cifar10/feded/temp'

for res_dir in os.listdir(dir):
    info = res_dir.split('_')
    student = f"cifar10_{info[5]}"
    loss = info[6]
    scheme = info[7]

    new_dir = f"/home/oscar/CAS/Exjobb/FedML-master-thesis/results/cifar10/feded/{'_'.join(info[:5])}"
