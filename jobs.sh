...
# python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_eft --algorithm fedavg --local_epochs 1 --n_rounds 300
# python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_gmg --algorithm fedavg --local_epochs 1 --n_rounds 300
# python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_mfb --algorithm fedavg --local_epochs 1 --n_rounds 300
# python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_xmo --algorithm fedavg --local_epochs 1 --n_rounds 300
# python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_ygi --algorithm fedavg --local_epochs 1 --n_rounds 300