...
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_eft --algorithm feded --local_epochs_ensemble 70 --n_rounds 1 --student_epochs 1000
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_gmg --algorithm feded --local_epochs_ensemble 70 --n_rounds 1 --student_epochs 1000
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_mfb --algorithm feded --local_epochs_ensemble 70 --n_rounds 1 --student_epochs 1000
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_xmo --algorithm feded --local_epochs_ensemble 70 --n_rounds 1 --student_epochs 1000
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_ygi --algorithm feded --local_epochs_ensemble 70 --n_rounds 1 --student_epochs 1000