...
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_bqa --algorithm fedavg --local_epochs 1 --n_rounds 300
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_rff --algorithm fedavg --local_epochs 1 --n_rounds 300
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_rgy --algorithm fedavg --local_epochs 1 --n_rounds 300
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_rls --algorithm fedavg --local_epochs 1 --n_rounds 300
python3 main.py --settings_file cifar10_c10_f1.0_iid_a0.1_sew --algorithm fedavg --local_epochs 1 --n_rounds 300